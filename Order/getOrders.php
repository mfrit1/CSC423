...
$sql = "SELECT orders.orderId, vendor.vendorCode, vendor.vendorName, retailstore.storeCode, retailstore.storeName, orders.dateTimeOfOrder, orders.status, orders.dateTimeOfFulfilment FROM orders, vendor, retailstore WHERE ((orders.vendorId = vendor.vendorId) AND (orders.storeId = retailstore.storeId))";
