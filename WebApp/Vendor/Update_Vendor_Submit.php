...
//  return $data;
//}
	$sql = "UPDATE vendor SET vendorName='{$vendorName}', address='{$address}', city='{$city}', state='{$state}', zip='{$zip}', phone='{$phone}', contactPersonName='{$contactPersonName}', password='{$password}' WHERE (vendorId='{$vendorId}')";
//echo $sql;
	echo $sql;
