    ...
    <form class="form-horizontal" method="post" id = "myForm" action = "Add_Customer_Submit.php"   >
      ...
      <div class="form-group row">
        <div class ="col-lg-4">
          ...
          <input type="text" class="form-control" name="customerAddress" id="customerAddress" placeholder="Enter Address of Customer" required>
        </div>
        <div class ="col-lg-4">
          <label for="customerCity">City</label>
          <input type="text" class="form-control" name="customerCity" id="customerCity" placeholder="Enter City" required>
        </div>
        <div class ="col-lg-2">
          <label for="customerState">State</label>
          <select class="form-control" name="customerState" id="customerState" selected="" required>
        ...
        <div class ="col-lg-2">
            ...
            <input type="text" class="form-control" name="customerZip" id="customerZip" placeholder="Enter Zip" required>
        </div>
      </div>
      <div style="height: 25px"></div>
      <div class="form-group row">
        <div class ="col-lg-4">
          ...
          <input type="text" class="form-control" name="customerPhone" id="customerPhone" placeholder="Enter Phone" required>
        </div>
        <div class ="col-lg-8">
