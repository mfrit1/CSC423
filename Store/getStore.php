...
$sql = "SELECT * FROM retailstore WHERE status='Active' ORDER BY CHAR_LENGTH(storeCode), storeCode";
...
{   
    ...
    echo "<td align=center><button type='button' class='btn btn-warning' style='padding-right: 10px' onclick='modifyStore($(this))'><i class='fa fa-pencil'></i></button><div class='divider'></div><button type='button' class='btn btn-danger' onclick='deleteStore($(this))'><i class='fa fa-trash'></i></button></td>";
    echo "</tr>";
}
