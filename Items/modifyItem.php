    ...
    <form class="form-horizontal" method="post" id = "myForm" action = "Modify_Item_Submit.php?id=' .  $data[0]  .'" >
      ...
      <div class="form-group row">
        <div class ="col-lg-3">
          ...
          <input type="text" class="form-control" name="itemId" id="number" value="' . $data[0] . '">
        </div>
        <div class ="col-lg-9">
          <label for="itemDepartment">Department</label>
          <input type="text" class="form-control" name="itemDepartment" id="itemDepartment" value="' . $data[4] . '">
        </div>
      </div>
      <div style="height: 25px"></div>
      <div class="form-group row">
        <div class ="col-lg-4">
          ...
          <input type="text" class="form-control" name="itemSize" id="Size" value="' . $data[2] . '">
        </div>
        <div class ="col-lg-4">
          <label for="itemCost">Item Cost</label>
          <input type="text" class="form-control" name="itemCost" id="itemCost" value="'  . $data[6] .  '">
        </div>
        <div class ="col-lg-4">
          <label for="retailPrice">Retail Price</label>
          <input type="text" class="form-control" name="retailPrice" id="retailPrice" value="' . $data[7] . '">
        </div>
      </div>
      <div style="height: 25px"></div>
      <div class="form-group row">
        <div class ="col-lg-12">
          ...
          <input type="text" class="form-control" name="itemDescription" id="Description" value="' . $data[1] . '">
        </div>
      </div>
      <div style="height: 25px"></div>
      <div class="form-group row">
        <div class ="col-lg-4">
          ...
          <select class="form-control" name="divisionDropdown" id="' . $data[3] . '">
        ...
        <div class ="col-lg-4">
          ...
          <select class="form-control" name="categoryDropdown" id="' . $data[5] . '">
        ...
        <div class ="col-lg-4">
          ...
          <select class="form-control" name="vendorDropdown" id="'  . $data[9] . '">
      ...
      <div class="form-group row">
        <div class ="col-lg-8">
          ...
          <input type="text" class="form-control" name="itemImagePath" id="itemImagePath" value="' . $data[8] . '" onkeyup="getImage()">
        </div>
        <div class ="col-lg-4">
