...
{   
    ...
    echo "<td align=center><button type='button' class='btn btn-warning' onclick='modifyOrder($(this))' style='padding-right: 10px'><i class='fa fa-pencil'></i></button><div class='divider'></div><button type='button' class='btn btn-danger'><i class='fa fa-trash'></i></button></td>";
    echo "</tr>";
}
?>