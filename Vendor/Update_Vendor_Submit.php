...
$sql = "UPDATE vendor SET vendorName=$vendorName, address=$address, city=$city, state=$state, zip=$zip, phone=$phone, contactPersonName=$contactPersonName, password=$password) WHERE vendorCode=$vendorCode;";
